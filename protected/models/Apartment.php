...
//            array('routeable_pattern', 'required'),
            ...
            array('room_number, square, square_live, square_kitchen, wc_number', 'numerical', 'integerOnly' => true),
            array('city_id, area_id, type_id, user_id', 'required'),
            array('name, floor, flat_number, ceiling_height', 'length', 'max' => 255),
